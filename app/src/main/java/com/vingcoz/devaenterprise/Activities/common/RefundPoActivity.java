...
public class RefundPoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.refund_po_activity);
        ...
        TextView txtRefundText = findViewById(R.id.txtRefundText);
